...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Put List</h1>
            </div>

            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{url('/admin/home')}}">Home</a></li>
                    <li class="breadcrumb-item"><a href="{{route('puts.index')}}">Put</a></li>
                    <li class="breadcrumb-item active">Put List</li>
                </ol>
            </div>
            ...
            <div class="col-md-12 m-auto">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Put list</h3>
                    </div>
                    ...
                    @endif
                    <div class="card-body">
                            <table id="puts-table" class="table table-hover table-striped">
                                    <thead>
                                        <tr>
                                            <th> # </th>
                                            <th>Name Arabic</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$put->name_en}}</td>
                                            <td>
                                                <form action="{{route('puts.destroy', $put->id)}}" method="POST">
                                                    @csrf {{ method_field('DELETE') }}
                                                    <a href="{{route('puts.edit', $put->id)}}" class="btn dark btn-sm btn-outline sbold uppercase">
