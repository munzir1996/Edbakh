...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Create Subscribe</h1>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-8 m-auto">
                    ...
                    <div class="card">
                        ...
                        <form method="POST" action="{{route('subscribes.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="tab_1">
                                        ...
                                        @include('admin.subscribes.create.form_en')
