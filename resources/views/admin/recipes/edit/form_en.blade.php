<div class="row">
        ...
        <div class="form-group col-6">
            <label>Title</label>
            <input type="text" name="title_en" value="{{$recipe->title_en}}" placeholder="Enter Title" class="form-control">
            <span class="text-danger">{{$errors->first('title_en')}}</span>
        </div>
    
        <div class="form-group col-6">
            <label>Subtitle</label>
            <input type="text" name="subtitle_en" value="{{$recipe->subtitle_en}}" placeholder="Enter Subtitle"
                class="form-control">
        ...
        <div class="form-group col-12">
            ...
            <textarea name="description_en" class="form-control ck_editor">{{$recipe->description_en}}</textarea>
        ...
        <div class="form-group col-4">
            ...
            <select name="component_id" class="form-control">
                ...
                <option value="{{$component->id}}" {{ $component->id == $recipe->component_id ? 'selected' : '' }}>{{$component->name_en}}</option>
                @endforeach
            </select>
        </div>
        <div class="form-group col-4">
            ...
            <select name="season_id" class="form-control">
                ...
                <option value="{{$season->id}}" {{ $season->id == $recipe->season_id ? 'selected' : '' }}>{{$season->name_en}}</option>
                @endforeach
            </select>
        </div>
        <div class="form-group col-4">
            ...
            <select name="dish_id" class="form-control">
                ...
                <option value="{{$dish->id}}" {{ $dish->id == $recipe->dish_id ? 'selected' : '' }}>{{$dish->name_en}}</option>
                @endforeach
            </select>
        </div>
        ...
        <div class="form-group col-12">
            ...
            <select name="plan_id" class="form-control">
                ...
                <option value="{{$plan->id}}" {{ $plan->id == $recipe->plan_id ? 'selected' : '' }}>{{$plan->title_en}}</option>
                @endforeach
            </select>
        </div>
        ...
        <div class="form-group col-12">
            ...
            <select name="date_id" class="form-control">
                ...
                <option value="{{$date->id}}" {{ $date->id == $recipe->date_id ? 'selected' : '' }}>{{$date->date_en}}</option>
                @endforeach
            </select>
        </div>
        ...
        <div class="form-group col-6">
                ...
                <img src="{{asset('public/uploads/'.$recipe->picture)}}" width="100%">
