<div class="row">
    ...
    <div class="form-group col-4">
        ...
        <select name="component_id" class="form-control">
            ...
            <option value="{{$component->id}}" {{ $component->id == $recipe->component_id ? 'selected' : '' }}>
                {{$component->name_en}}</option>
            @endforeach
        </select>
    </div>
    <div class="form-group col-4">
    ...
    <div class="form-group col-12">
        ...
        <select name="plan_id" class="form-control">
            ...
            <option value="{{$plan->id}}" {{ $plan->id == $recipe->plan_id ? 'selected' : '' }}>
    ...
    <div class="form-group col-12">
        ...
        <select name="date_id" class="form-control">
            ...
            <option value="{{$date->id}}" {{ $date->id == $recipe->date_id ? 'selected' : '' }}>
                {{$date->date_en}}</option>
            @endforeach
        </select>
    </div>
