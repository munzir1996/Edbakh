...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Main Component List</h1>
            </div>

            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{url('/admin/home')}}">Home</a></li>
                    <li class="breadcrumb-item"><a href="{{route('components.index')}}">Main Component</a></li>
                    <li class="breadcrumb-item active">Main Component List</li>
                </ol>
            </div>
            ...
            <div class="col-md-12 m-auto">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Main Component list</h3>
                    </div>
                    ...
                    @endif
                    <div class="card-body">
                            <table id="components-table" class="table table-hover table-striped">
                                    <thead>
                                        <tr>
                                            <th> # </th>
                                            <th>Name Arabic</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{route('components.destroy', $component->id)}}" method="POST">
                                                    ...
                                                    <a href="{{route('components.edit', $component->id)}}" class="btn dark btn-sm btn-outline sbold uppercase">
