...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Edit an Seasonal Recipes</h1>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-8 m-auto">
                    ...
                    <div class="card">
                        ...
                        <form method="POST" action="{{route('seasons.update', ['id' => $season->id])}}" enctype="multipart/form-data">
                            ...
                            <div class="card-header d-flex p-0">
                                <h3 class="card-title p-3">Seasonal Recipes Information</h3>
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="tab_1">
                                        ...
                                        @include('admin.seasons.edit.form_en')

                                    </div>

                                    <div class="tab-pane" id="tab_2">

                                        @include('admin.seasons.edit.form_ar')
                            ...
                            <div class="card-footer text-center">
                                ...
                                <a href="{{route('seasons.index')}}" class="btn btn-secondary">Cancel</a>
